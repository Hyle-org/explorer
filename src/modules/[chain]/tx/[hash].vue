        ...
        <div v-else>
            ...
            <div v-if="tx.tx_response" class="bg-base-100 px-4 pt-3 pb-4 rounded shadow mb-4">
                <div class="flex justify-between">
                    ...
                    <button @click="showProof = !showProof" class="border-slate-400 border rounded-xl px-4">
                        {{ showProof ? 'Hide Messages' : 'Show Messages' }}
                    </button>
                </div>

                <div v-if="showProof">
                    <div v-for="(msg, i) in messages" :key="i" class="border border-slate-400 rounded-md mt-4">
