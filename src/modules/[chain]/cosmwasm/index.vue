    ...
    <div class="bg-base-100 px-4 pt-3 pb-4 rounded mb-4 shadow">
        ...
        <div class="overflow-x-auto">
            <table class="table table-compact w-full mt-4 text-sm">
                ...
                <tbody>
                    <tr v-for="v, index in contractList.contracts" :key="index">
                        <td><RouterLink :to="`/${props.chain}/cosmwasm/0/transactions?contract=${v}`">{{ v }}</RouterLink></td>
                        <!--
                        <td>{{ v.code_id }}</td>
                        <td>
            ...
            <div class="flex justify-between">
                <PaginationBar :limit="pageRequest.limit" :total="contractList.pagination?.total" :callback="pageload" />
